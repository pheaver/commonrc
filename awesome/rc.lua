...
package.path = package.path .. ';/home/pweaver/Dropbox/linux/awesome/?.lua'
local hasShift, shifty = pcall(require, "shifty")
local hasCheeky, cheeky = pcall(require, "cheeky")
local hasAPW, APW = pcall(require, "apw/widget")
...
mymainmenu = awful.menu({ items = { { "awesome", myawesomemenu, beautiful.awesome_icon },
                                    ...
                                    -- { "switch user", terminal .. " -e /usr/bin/mdmflexiserver" },
                                    { "terminal", terminal },
...
-- mytextclock = awful.widget.textclock( "%a %b %d, %H:%M ") // default date format
...
mytasklist.buttons = awful.util.table.join(
                     ...
                     awful.button({ }, 4, nextClient),
                     awful.button({ }, 5, prevClient))
...
for s = 1, screen.count() do
    ...
    if hasAPW then right_layout:add(APW) end
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "j", nextClient),
    awful.key({ modkey,           }, "k", prevClient),
    ...
    awful.key({ modkey,           }, "Tab", focusPrevClient ),
    ...
    awful.key({ }, "XF86MonBrightnessDown", function ()
          awful.util.spawn("xbacklight -dec 10 -time 0") end),
...
if hasAPW then
  globalkeys = awful.util.table.join(globalkeys,
    ...
    awful.key({ modkey, }, "KP_Insert",             APW.ToggleMute),
    awful.key({ modkey, }, "KP_0",                  APW.ToggleMute)
  )
end
...
clientkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "m",      toggleMaximized                                  )
)
...
awful.rules.rules = {
    ...
    --   properties = { tag = tags[1][2] } },
    -- { rule = { class = "Pidgin" },
    --   properties = { tag = tags[1][2] } }, -- screen 1, tag 2
